//! Google Gemini backend (`/chat/completions` compat endpoint + thought signatures).

use std::sync::Arc;

use super::chat_completions::{ChatCompletionsBackend, GeminiAdapter};

pub struct GeminiBackend(ChatCompletionsBackend);
...
impl super::super::llm::LlmBackend for GeminiBackend {
