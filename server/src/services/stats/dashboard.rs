...
use crate::{
    ...
    models::stats_builder::{
        SavedStatsQuery, SavedStatsQueryWrite, StatsBuilderBody, StatsTableResponse,
    },
...
impl StatsService {
    ...
    pub async fn list_saved_queries(
        ...
        crate::repository::stats::saved_queries::list_for_user(
    ...
    pub async fn update_saved_query(
        ...
        crate::repository::stats::saved_queries::update(
            self.repository.pool(),
            id,
            user_id,
            is_admin,
    ...
    pub async fn delete_saved_query(&self, id: i64, user_id: i64, is_admin: bool) -> AppResult<()> {
        crate::repository::stats::saved_queries::delete_by_id(
            self.repository.pool(),
            id,
            user_id,
            is_admin,
